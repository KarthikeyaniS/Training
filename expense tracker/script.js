...
//     document.getElementById('text-list').innerHTML= txt;
//     document.getElementById('amount-list').innerHTML= amt;

//     var trans = document.createElement("list");
//     var td1 = document.createElement("text-list");
